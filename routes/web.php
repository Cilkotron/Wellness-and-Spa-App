...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'name' => 'admin'], function()
{
    ...
    Route::delete('event/destroy/{id}', 'Admin\EventController@destroy')->name('event.delete');
    Route::get('listEvent','Admin\EventController@listEvent')->name('allEvent');
    /* reservation */
    ...
    Route::get('reservation/calendar', 'Admin\ReservationController@calendar')->name('reservation.calendar');
